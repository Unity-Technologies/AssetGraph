...
public partial class Test {
	...
	public void _5_2_PlatformChanging () {
		...
		var dataPath = Path.Combine(Application.dataPath, "AssetGraphTest/Editor/TestData");
		var graphDataPath = Path.Combine(dataPath, "_5_2_PlatformChanging.json");
		...
		// cache generated.
		uint before_iOSAssetGUID;
		BuildPipeline.GetCRCForAssetBundle("Assets/AssetGraph/Cache/BundleBuilt/05ad002c-5e3a-46e3-97e3-01543516c728/iOS/chara_0.assetbundle", out before_iOSAssetGUID);
		...
		uint after_iOSAssetGUID;
		BuildPipeline.GetCRCForAssetBundle("Assets/AssetGraph/Cache/BundleBuilt/05ad002c-5e3a-46e3-97e3-01543516c728/iOS/chara_0.assetbundle", out after_iOSAssetGUID);

		if (after_iOSAssetGUID != before_iOSAssetGUID) Debug.LogError("failed to cache after_iOSAssetGUID:" + after_iOSAssetGUID + " before_iOSAssetGUID:" + before_iOSAssetGUID);
	}

	public void _5_3_PlatformChanging_rev () {
		...
		// cache generated.
		uint before_iOSAssetGUID;
		BuildPipeline.GetCRCForAssetBundle("Assets/AssetGraph/Cache/BundleBuilt/05ad002c-5e3a-46e3-97e3-01543516c728/StandaloneOSXIntel/chara_0.assetbundle", out before_iOSAssetGUID);
