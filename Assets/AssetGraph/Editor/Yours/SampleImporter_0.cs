...
public class SampleImporter_0 : AssetGraph.ImporterBase {

	public override void AssetGraphOnPreprocessTexture () {
		Debug.Log("SampleImporter_0 AssetGraphOnPreprocessTexture started.");
		...
		Debug.Log("SampleImporter_0 AssetGraphOnPreprocessTexture completed.");
	}
