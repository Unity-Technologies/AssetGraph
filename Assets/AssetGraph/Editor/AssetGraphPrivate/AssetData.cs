...
namespace AssetGraph {
	public class AssetData {
		...
		*/
		public static AssetData AssetDataByImporter (string traceId, string absoluteSourcePath, string sourceBasePath, string fileNameAndExtension, string pathUnderSourceBase, string importedPath, string assetId, Type assetType) {
			return new AssetData(
				traceId,
				absoluteSourcePath,
				sourceBasePath,
		...
		*/
		public static AssetData AssetDataGeneratedByImporterOrPrefabricatorOrBundlizer (string importedPath, string assetId, Type assetType) {
			return new AssetData(
				Guid.NewGuid().ToString(),
				null,
				null,
