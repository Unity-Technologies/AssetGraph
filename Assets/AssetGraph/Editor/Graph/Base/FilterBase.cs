...
namespace AssetGraph {
	public class FilterBase : NodeBase {
		...
		public override void Setup (List<string> source, Action<string, string, List<string>> Output) {
			this.Output = Output;
			In(source, _PreOut);
		}
		...
		*/
		public override void Run (List<string> dummy) {
			Debug.LogError("この中で親を辿るの頑張らなくても良さそう。");
